...
git branch -M main
git remote add origin git@github.com:elpaco-escience/scikit-talk
```

## Push the initial commit to a new repo on GitHub

Go to
[https://github.com/organizations/elpaco-escience/repositories/new](https://github.com/organizations/elpaco-escience/repositories/new)
and create a new repository named `scikit-talk` as an empty repository, then push your commits to GitHub:
...
automatically ([here](git@github.com:elpaco-escience/scikit-talk/issues?q=author%3Aapp%2Fgithub-actions)). Resolve them to complete the
